...
public class WeatherForecastInfoViewModel extends AndroidViewModel {

    /** Contains basic weather information to be represented */
    private MutableLiveData<List<WeatherBasicInformation>> information;

    public WeatherForecastInfoViewModel(@NonNull Application application) {
        super(application);
     ...
     */
    public void addForecastInfoObserver(@NonNull LifecycleOwner owner,
