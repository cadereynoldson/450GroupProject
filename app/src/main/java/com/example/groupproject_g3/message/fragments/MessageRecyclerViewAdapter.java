...
import com.example.groupproject_g3.databinding.FragmentMessageChatBinding;
...
public class MessageRecyclerViewAdapter extends RecyclerView.Adapter<MessageRecyclerViewAdapter.MessageViewHolder>{
    private final List<MessageChat> mMessages;
    private final String mEmail;
    public MessageRecyclerViewAdapter(List<MessageChat> messages, String email) {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MessageViewHolder(LayoutInflater
                ...
                .inflate(R.layout.fragment_message_chat, parent, false));
    }
    ...
    class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public MessageViewHolder(@NonNull View view) {
            super(view);
            mView = view;
            binding = FragmentMessageChatBinding.bind(view);
        }

        void setMessage(final MessageChat message) {
            final Resources res = mView.getContext().getResources();
            final MaterialCardView card = binding.cardRoot;

            int standard = (int) res.getDimension(R.dimen.message_margin);
            int extended = (int) res.getDimension(R.dimen.message_margin_sided);
