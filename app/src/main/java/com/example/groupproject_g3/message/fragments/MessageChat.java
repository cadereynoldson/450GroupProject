...
public class MessageChat implements Serializable {
    ...
    public MessageChat(int messageId, String message, String sender, String timeStamp) {
     ...
     */
    public static MessageChat createFromJsonString(final String cmAsJson) throws JSONException {
        final JSONObject msg = new JSONObject(cmAsJson);
        return new MessageChat(msg.getInt("messageid"),
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof MessageChat) {
            result = mMessageId == ((MessageChat) other).mMessageId;
        }
        return result;
    }
}
