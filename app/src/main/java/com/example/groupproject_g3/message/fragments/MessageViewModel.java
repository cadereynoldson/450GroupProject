...
public class MessageViewModel extends AndroidViewModel {
     ...
     */
    private Map<Integer, MutableLiveData<List<MessageChat>>> mMessages;
    ...
    public void addMessageObserver(int chatId,
                                   ...
                                   @NonNull Observer<? super List<MessageChat>> observer) {
     ...
     */
    public List<MessageChat> getMessageListByChatId(final int chatId) {
        return getOrCreateMapEntry(chatId).getValue();
    }

    private MutableLiveData<List<MessageChat>> getOrCreateMapEntry(final int chatId) {
     ...
     * @param message
     */
    public void addMessage(final int chatId, final MessageChat message) {
        List<MessageChat> list = getMessageListByChatId(chatId);
        list.add(message);
    ...
    private void handelSuccess(final JSONObject response) {
        ...
        try {
            ...
            for(int i = 0; i < messages.length(); i++) {
                ...
                MessageChat cMessage = new MessageChat(
